...
def GenerateWikiRecipeToItemData(target, targetDict, NpcDict):
	...
	if targetKeywordSet:
		for npc in NpcDict:
			...
			if prefList:
				# print : show npc name for debuging if error is link to a location. check npc location in jsons/version/npclocation.json
				# if npc is not in the npclocation.json, add it.
				# print(npc)
